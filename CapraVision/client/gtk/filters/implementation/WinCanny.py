...
class WinCanny:
    ...
    def init_window(self):
        self.spnThreshold1.set_value(self.filtre_init.threshold1.get_current_value())
        self.spnThreshold2.set_value(self.filtre_init.threshold2.get_current_value())
    ...
    def on_btnCancel_clicked(self, widget):
        self.filtre.threshold1.set_current_value(self.filtre_init.threshold1.get_current_value())
        self.filtre.threshold2.set_current_value(self.filtre_init.threshold2.get_current_value())
    
    def on_spnThreshold1_value_changed(self, widget):
        self.filtre.threshold1.set_current_value(self.spnThreshold1.get_value())
    
    def on_spnThreshold2_value_changed(self, widget):
        self.filtre.threshold2.set_current_value(self.spnThreshold2.get_value())
